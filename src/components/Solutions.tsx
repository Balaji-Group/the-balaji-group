    ...
    <section id="solutions" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-heading font-bold text-primary mb-6">Our Solutions</h2>
          ...
          <div className="bg-secondary rounded-2xl p-8 max-w-5xl mx-auto">
            <h3 className="text-2xl font-heading font-bold text-primary mb-4">Our Role In Packaging</h3>
        ...
        {/* Industries Served */}
        <div className="mt-20">
          <h3 className="text-3xl font-heading font-bold text-center text-primary mb-12">Industries We Serve</h3>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-card rounded-lg p-4 shadow-md hover:shadow-lg transition-shadow text-center">
