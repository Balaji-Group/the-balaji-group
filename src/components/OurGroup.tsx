...
const OurGroup = () => {
  ...
  const teamMembers = [{
    ...
    joinYear: "2024",
    description: "Running daily operations has taught me that genuinely listening to challenges and always trying to improve, even in small ways, is what keeps our business moving forward."
  }];
