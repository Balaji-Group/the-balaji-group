import { Calendar, MapPin, Factory, Truck, Briefcase, Users, Download } from 'lucide-react';
          ...
          {companies.map((company, index) => <CarouselItem key={index} className="pl-4 basis-full">
            <div className="group relative h-full">
              <div className="card p-8 h-full flex flex-col">
                ...
                {/* Download Brochure Button for each company */}
                {company.brochure && (
                  <div className="mt-6 pt-4 border-t border-border">
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      className="w-full border-accent/50 text-accent hover:bg-accent hover:text-white transition-all"
                    >
                      <a href={withBase(company.brochure)} download>
