...
const Hero = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center gradient-bg dark:gradient-bg-dark overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-brand-blue/20 to-transparent rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 py-20 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="animate-fade-in">
            ...
            <h1 className="text-5xl lg:text-7xl font-heading font-bold text-brand-navy dark:text-white mb-6 leading-tight">
            ...
            <p className="text-2xl lg:text-3xl text-brand-slate-600 dark:text-brand-slate-300 font-medium mb-6 tracking-wide">
              A Complete House of <span className="text-brand-blue font-semibold">Packaging</span>
            </p>
            
            <p className="text-lg text-brand-slate-600 dark:text-brand-slate-400 mb-10 max-w-xl leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Button 
                variant="outline" 
                size="lg"
                className="border-brand-navy text-brand-navy hover:bg-brand-navy hover:text-white dark:border-brand-slate-400 dark:text-brand-slate-300 dark:hover:bg-brand-slate-300 dark:hover:text-brand-navy transition-all"
              >
                Contact Us
              </Button>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-brand-navy dark:text-white">22+</div>
                <div className="text-sm text-brand-slate-500 dark:text-brand-slate-400">Years Experience</div>
              </div>
              <div className="text-center">
                <div className="flex justify-center mb-3">
                  <div className="w-12 h-12 bg-brand-blue/10 dark:bg-brand-blue/20 rounded-xl flex items-center justify-center">
                    <Shield className="w-6 h-6 text-brand-blue" />
                  </div>
                </div>
                <div className="text-2xl font-bold text-brand-navy dark:text-white">ISO</div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-brand-navy dark:text-white">5</div>
              ...
              <div className="text-center">
                ...
                <div className="text-2xl font-bold text-brand-navy dark:text-white">1000+</div>
          ...
          <div className="relative flex items-center justify-center lg:justify-end animate-slide-up">
            <div className="relative">
              {/* Background elements */}
              <div className="absolute inset-0 bg-gradient-to-br from-brand-red/5 via-brand-blue/5 to-brand-navy/5 rounded-3xl blur-3xl scale-110"></div>
              ...
              <div className="relative z-10 glass-effect dark:glass-effect-dark rounded-3xl p-12 shadow-large">
                <div className="text-center">
                  ...
                  <h3 className="text-3xl font-heading font-bold text-brand-navy dark:text-white mb-2 tracking-wide">
                    BALAJI GROUP
                  </h3>
              ...
              <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-brand-blue/20 rounded-xl rotate-45 blur-sm"></div>
